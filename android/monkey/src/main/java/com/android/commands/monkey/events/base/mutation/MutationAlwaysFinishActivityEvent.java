...
public class MutationAlwaysFinishActivityEvent extends MonkeyEvent {

    private boolean isOpen = false;

    public MutationAlwaysFinishActivityEvent() {
        super(EVENT_TYPE_COMMON);
        isOpen = isAlwaysFinishActivitysOpen();
    ...
    public int injectEvent(IWindowManager iwm, IActivityManager iam, int verbose) {
        String cmd = isOpen ? "settings put global always_finish_activities 0" : "settings put global always_finish_activities 1";
