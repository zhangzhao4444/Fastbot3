...
CLASSPATH='/sdcard/monkeyq.jar:/sdcard/framework.jar:/sdcard/fastbot-thirdpart.jar:/sdcard/kea2-thirdpart.jar' exec app_process /system/bin com.android.commands.monkey.Monkey -p com.jingdong.app.mall --agent double-sarsa --running-minutes 10 --throttle 100 -v -v -v --output-directory /sdcard/my-fastbot-logs"
